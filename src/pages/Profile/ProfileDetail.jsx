        ...
        <form>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              ...
              <label htmlFor="genderPublic" className="text-sm text-gray-600">
                Công khai
              </label>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              ...
              <label htmlFor="phonePrivate" className="text-sm text-gray-600">
                Chỉ mình tôi
              </label>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              ...
              <label htmlFor="emailPrivate" className="text-sm text-gray-600">
                Chỉ mình tôi
              </label>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="p-2 w-1/2 border rounded"
              />
              <input type="checkbox" id="facebookPrivate" className="mt-2" />
              <label
